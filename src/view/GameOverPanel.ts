...
class GameOverPanel extends BasePanel{
    ...
    private setBtn2:ImgButton;
    private helpBtn2:ImgButton;
    private shopBtn2:ImgButton;
    private fbBtn2:ImgButton;
    ...
    public initPanel():void{
        ...
        this.alertTF = new HtmlText([["下面",0x000000],["是",0x55ff00],["confirm",0x000000],["组件",0x55ff00]],30,false,1,0xFFFFFF);
        this.alertTF.x = this.w/2 - this.alertTF.width/2;
        this.alertTF.y = 120;
        this.addChild(this.alertTF);
        this.alertTF.alpha = 0;

        this.tipsTF = new HtmlText([["下面",0x000000],["是",0x55ff00],["tips飘字",0x000000],["组件",0x55ff00]],30,false,1,0xFFFFFF);
